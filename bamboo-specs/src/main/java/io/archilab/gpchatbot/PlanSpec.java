            ...
            .jobs(new Job("Default Job",
                ...
                .tasks(new VcsCheckoutTask()
                    ...
                    new ScriptTask()
                        ...
                        .inlineBody(
                            "docker tag docker.nexus.gpchatbot.archi-lab.io/chatbot/action-server docker.nexus.gpchatbot.archi-lab.io/chatbot/action-server:${bamboo.inject.commit-hash}"),
                    new DockerPushImageTask()
                        .customRegistryImage(
                            "docker.nexus.gpchatbot.archi-lab.io/chatbot/action-server")
                        .defaultAuthentication(),
                    new DockerPushImageTask()
                        .customRegistryImage(
                            "docker.nexus.gpchatbot.archi-lab.io/chatbot/action-server:${bamboo.inject.commit-hash}")
                        .defaultAuthentication(),
                    new ScriptTask()
            ...
            .tasks(new CleanWorkingDirectoryTask(),
                new ArtifactDownloaderTask()
                    ...
                    .artifacts(new DownloadItem()
                        ...
                        .path("./artifacts")),
                new ScriptTask()
                    .description("Deploy the Docker stack via docker-machine")
                    .inlineBody(
